...
import com.nightwhite.app.sensors.BatteryMonitor
import com.nightwhite.app.sensors.FaceDownDetector
import com.nightwhite.app.service.AudioService
import com.nightwhite.app.ui.MainScreen
import com.nightwhite.app.ui.theme.NightlightTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.setAudioMode(com.nightwhite.app.model.AudioMode.NOISE)
    ...
    private fun updateAudioService(isSoundOn: Boolean) {
        ...
        if (isSoundOn) {
            ...
            val label = if (mode == com.nightwhite.app.model.AudioMode.LULLABY) "Lullaby playing" else "${noiseColor.name.lowercase()} noise playing"
